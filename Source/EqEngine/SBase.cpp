...
ASBase::ASBase()
{
	...
	CollisionComp->BodyInstance.SetCollisionProfileName("SpellProjectile");
	CollisionComp->OnComponentHit.AddDynamic(this, &ASBase::OnHit);		// set up a notification for when this component hits something blocking
